...
Public Class Databasesselecter
    ...
    Private Sub Nam_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Nam2.TextChanged
        If Savings2C.Checked = True Then
            If (ConnStr2.State And 1) = 1 Then
                ConnStr2.AddNew()
    ...
    Private Sub Label1_DoubleClick(sender As Object, e As EventArgs)
        Me.Location = New Point(Main.Location.X, Main.Location.Y)
    End Sub

    Private Sub Databasesselecter_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        e.Cancel = True
                ...
                For counter = 1 To 30
                    Try
                        ...
                        ElseIf ConnStr.Fields("ID").Value = "Save" And Savings2C.Checked = False Then
                            ...
                            ConnStr.Update()
                        End If
                        If ConnStr.Fields("ID").Value = "ASS" And ASSC.Checked Then
                            ConnStr.Fields("Valu").Value = ASST.Text
                        ElseIf ConnStr.Fields("ID").Value = "ASS" Then
                            ConnStr.Fields("Valu").Value = "False"
                        End If
                        If ConnStr.Fields("ID").Value = "FeedC" Then
                            ConnStr.Fields("Valu").Value = FeedC.Checked.ToString
